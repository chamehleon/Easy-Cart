              ...
              <div class="tm-notification-items">
                <div class="media tm-notification-item">
                  <div class="tm-gray-circle">
                    <img
                      src="assets/adminAssets/img/notification-01.jpg"
                      alt="Avatar Image"
                ...
                <div class="media tm-notification-item">
                  <div class="tm-gray-circle">
                    <img
                      src="assets/adminAssets/img/notification-02.jpg"
                      alt="Avatar Image"
                      class="rounded-circle"
                    />
                  </div>
                ...
                <div class="media tm-notification-item">
                  <div class="tm-gray-circle">
                    <img
                      src="assets/adminAssets/img/notification-03.jpg"
                      alt="Avatar Image"
                      class="rounded-circle"
                    />
                  </div>
                  <div class="media-body">
                    <p class="mb-2">
                      ...
                      <a href="#" class="tm-notification-link">order updates</a
