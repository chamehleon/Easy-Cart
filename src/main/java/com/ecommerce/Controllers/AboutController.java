...
public class AboutController implements IController {
    ...
    private static com.ecommerce.Controllers.AboutController instance;

    private AboutController() {
    }

    public static com.ecommerce.Controllers.AboutController getInstance() {
        if (instance == null) {
            instance = new com.ecommerce.Controllers.AboutController();
        }
        return instance;
    }
