	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-lg-3 p-b-50">
				...
				<ul>
					<li class="p-b-10">
						<a
								href="front?controller=FetchProducts&category=women"
					...
					<li class="p-b-10">
						<a
								href="front?controller=FetchProducts&category=men"
								class="stext-107 cl7 hov-cl1 trans-04"
						>
							Men
						</a>
		...
		<div class="p-t-40">
			...
			<p class="stext-107 cl6 txt-center">
				...
				<a href="https://colorlib.com" target="_blank">MAEVE</a> &amp;
				distributed by
				<a href="https://themewagon.com" target="_blank">MAEVE Co.</a>
				<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
			</p>
		</div>
	</div>
