...
public class AdminLogOutController implements IController {
    private static AdminLogOutController instance;

    private AdminLogOutController() {
    }

    public static AdminLogOutController getInstance() {
        if (instance == null) {
            instance = new AdminLogOutController();
        }
        return instance;
    }
    ...
    public ViewResolver resolve(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (method.equals("GET")) {
                ...
                response.sendError(401, "You are logged out.");
